...
class TestRepresentativeLength(unittest.TestCase):
    ...
    def test_repLength(self):
        ...
        rep_length_col = representative_length(self.lines, self.profiles)
        profile_dict = {profile['properties']['ids']: profile for profile in rep_length_col}

        self.assertEqual(profile_dict[1]['properties']['voor_lengte'], 4)
        self.assertEqual(profile_dict[1]['properties']['na_lengte'], 5.5)
        self.assertEqual(profile_dict[2]['properties']['voor_lengte'], 5.5)
        self.assertEqual(profile_dict[2]['properties']['na_lengte'], 5)
        self.assertAlmostEqual(profile_dict[3]['properties']['voor_lengte'], 2.8284271, places=7)
        self.assertAlmostEqual(profile_dict[3]['properties']['na_lengte'], 4.596194, places=6)
        self.assertAlmostEqual(profile_dict[4]['properties']['voor_lengte'], 4.596194, places=6)
        self.assertAlmostEqual(profile_dict[4]['properties']['na_lengte'], 2.1213203, places=7)

        self.assertEqual(profile_dict[5]['properties']['voor_lengte'], 2.0)
        self.assertAlmostEqual(profile_dict[5]['properties']['na_lengte'], 2.0036734, places=7)
        self.assertAlmostEqual(profile_dict[6]['properties']['voor_lengte'], 2.0036734, places=7)
        self.assertAlmostEqual(profile_dict[6]['properties']['na_lengte'], 5.880241, places=6)
        self.assertAlmostEqual(profile_dict[7]['properties']['voor_lengte'], 5.880241, places=6)
        self.assertEqual(profile_dict[7]['properties']['na_lengte'], 1.0)